    ...
    <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
      ...
      <div class="lg:flex flex-grow items-center bg-white lg:bg-transparent lg:shadow-none"
        ...
        <ul class="flex flex-col lg:flex-row list-none mr-auto">
          ...
          <li class="flex items-center">
            <a class="lg:text-white lg:hover:text-gray-300 text-gray-800 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
              href="#contact"><i class="lg:text-gray-300 text-gray-500 far fa-file-alt text-lg leading-lg mr-2"></i>
              Bog'lanish</a>
          </li>
        </ul>
        ...
        <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
          <li class="flex items-center">
            <button
              ...
              <div class="h-5">
                <nuxt-link v-if="uzLang" :to="switchLocalePath('uz')" @click="toggleLang">Uzbek</nuxt-link>
                <nuxt-link v-else :to="switchLocalePath('jp')" @click="toggleLang">Japanese</nuxt-link>
              </div>
            </button>
          </li>
        </ul>
